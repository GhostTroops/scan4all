...
const (
	Full        = "1-65535"
	Httpports   = "21-23,53,80-99,111,123,389,443,636,873,888,1433,1521,2000,2001,2049,2301,2381,3306,3389,4430,4433,5000,5001,5190,5357,5432,5631,5666,5672,5800,5900,6000-6010,6060,6379,6443,6646,6666,7000-7010,7443,7070,7777,8000-8010,8080-8100,8443,8686,8800,8880-8888,9000-9010,9080,9090,9200,9443,9527,9999,10000-10010,10443,15805,18000-18010,18443,19000-19010,19999,22222,28000-28010,29000-29010,38000-38010,39000-39010,48000-48010"
...
func ParsePorts(options *Options) ([]int, error) {
	...
	if options.TopPorts != "" {
		...
		if strings.EqualFold(options.TopPorts, "http") {
			ports, err := parsePortsList(Httpports)
			if err != nil {
				return nil, fmt.Errorf("could not read ports: %s", err)
			}
			topPortsCLIMap, err = excludePorts(options, ports)
