...
var (
	...
	filedic          = []string{".bash_history", ".bash_logout", ".bash_profile", ".bashrc", ".DS_Store", ".env", ".git/config", ".git/index", ".gitlab-ci.yml", ".htaccess", ".idea/modules.xml", ".index.php.swp", ".vimrc", "1.jspx", "1.tar.bz2", "1.txt", "druid/spring.html", "swagger-ui.html", "_async/AsyncResponseServiceSoap12", "a.php", "actuator", "actuator/env", "actuator/health", "actuator/health.json", "actuator/heapdump", "actuator/metrics", "admin/env", "manage/env", "admin", "Admin", "admin.html", "admin.jsp", "admin.php", "admin/", "admin/heapdump", "api", "openapi/v2", "swaggerapi", "api.php", "api/proxy", "api/proxy?url=", "api/swagger-ui.html", "api/user", "api/v2/api-docs", "app.js", "app/.git/config", "app/.git/index", "application.wadl", "auth/login", "autoconfig", "bower_components/underscore/README.md", "build.xml", "CHANGELOG", "CHANGELOG.md", "changelog.txt", "CHANGELOG.txt", "common/m_intl_common_header/gulpfile.js", "composer.json", "composer.lock", "config", "config.js", "configprops", "console/", "consul", "Controls/Ueditor/", "core", "dashboard/", "data/", "data", "debug", "debug/pprof/", "debug/vars", "demo", "Dockerfile", "docs", "docs.html", "download", "druid/index.html", "elasticsearch", "env", "env.json", "env/", "examples/", "examples/index.html", "explore/", "health/readiness", "sofaboot/versions", "sofaboot/", "actuator/versions", "actuator/readiness", "explore/projects", "Gruntfile.js", "gulpfile.js", "health", "heapdump", "Help", "help/sys/help.html", "hystrix.stream", "i.php", "index.php.bak", "INSTALL", "install", "install.sh", "item/admin", "java", "java/", "js/extjs/examples/feed-viewer/view.html", "js/extjs/examples/index.html", "js/Gruntfile.js", "LICENSE", "license.txt", "LICENSE.txt", "log.html", "log4j.properties", "login", "Login.aspx", "login/login", "Login/Login", "manage", "metrics", "metrics/", "monitor", "nginx.conf", "nginx_status", "nohup.out", "npm-debug.log", "p.php", "package-lock.json", "package.json", "project/details/swagger-ui.html", "proxy", "public/README.md", "query?q=SHOW%20STATS", "README", "readme.html", "README.md", "readme.md", "readme.txt", "README.txt", "resources/Gruntfile.js", "s/README.md", "seeyon/", "service/rest/swagger.json", "services", "services/", "signin", "sso/swagger-ui.html", "sso/v2/api-docs", "stat", "static/lv2/README.md", "static/videoui/README.md", "statistics", "stats", "status", "swagger-resources", "swagger-ui.html", "swagger-ui/index.html", "swagger/docs/v1", "swagger/ui/index", "test", "test.aspx", "test.htm", "test.html", "test.js", "test.jsp", "test.log", "test.php", "test1", "trace", "Trace.axd", "ucbrowser/test.php", "ueditor/", "ueditor/jsp/config.json", "ueditor/php/config.json", "update", "updates", "UPGRADE", "UpgradeLog.XML", "Upload", "upload.do", "upload.html", "upload.php", "Uploadify/uploadify.swf", "users/sign_in", "v2/api-docs", "vendor/composer/LICENSE", "version", "web", "web.config", "webservice", "wiki", "wls-wsat/CoordinatorPortType11", "wp-json/", "wp-json/wp/v2/users", "ws", "xmlrpc.php", "xmlrpc_server.php", "zabbix/", "grafana/", "zentao/"}
	HttpProxy        string
)
