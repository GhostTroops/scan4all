...
var (
	...
	filedic          = []string{"/swagger-ui.html", "/actuator", "/actuator/env", "/api/swagger-ui.html", "/api/v2/api-docs", "/config", "/config.js", "/console/", "/druid/index.html", "/env", "/env.json", "/swagger-resources", "/swagger-ui.html", "/swagger-ui/index.html", "/swagger/docs/v1", "/swagger/ui/index", "/test", "/test.aspx", "/test.htm", "/test.html", "/test.js", "/test.jsp", "/test.log", "/test.php", "/api/upload", "/upload/", "/upload.do", "/upload.html", "/upload.php", "/upload.jsp", "/zabbix/", "/grafana/", "/zentao/", "/seeyon/"}
	HttpProxy        string
)
