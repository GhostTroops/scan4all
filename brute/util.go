...
var (
	...
	jbossuserpass    = []userpass{{"jboss", "jboss"}, {"admin", "admin"}, {"jboss", "123456"}, {"admin", "123456"}}
	...
	weblogicuserpass = []userpass{{"weblogic", "weblogic"}, {"weblogic", "welcome1"}, {"weblogic", "Oracle@123"}, {"weblogic", "123456"}, {"weblogic", "weblogic123"}, {"system", "password"}, {"guest", "guest"}, {"portaladmin", "portaladmin"}, {"admin", "security"}, {"joe", "password"}, {"mary", "password"}, {"system", "security"}, {"wlcsystem", "wlcsystem"}, {"wlcsystem", "sipisystem"}}
	filedic          = []string{"/admin/", "/manager/html", "/env", "/actuator", "/actuator/env", "/config", "/config.js", "/console/login/LoginForm.jsp", "/druid/index.html", "/env.json", "/.env", "/api/swagger-ui.html", "/api/v2/api-docs", "/api/v1/api-docs", "/swagger-resources", "/swagger-ui.html", "/swagger-ui/index.html", "/swagger/docs/v1", "/swagger/docs/v2", "/swagger/ui/index", "/test", "/test.aspx", "/test.htm", "/test.html", "/test.js", "/test.jsp", "/test.log", "/test.php", "/upload", "/api/upload", "/upload/", "/upload.do", "/upload.html", "/upload.php", "/upload.jsp", "/upload.aspx", "/zabbix/", "/grafana/", "/zentao/", "/seeyon/", "/.git/config", "/.svn/entries", "/phpinfo.php", "/www.zip", "/www.rar", "/www.7z", "/www.tar.gz", "/www.tar", "/web.zip", "/web.rar", "/web.7z", "/web.tar.gz", "/web.tar", "/wwwroot.zip", "/wwwroot.rar", "/wwwroot.7z", "/wwwroot.tar.gz", "/wwwroot.tar", "/data.zip", "/data.rar", "/data.7z", "/data.tar.gz", "/data.tar", "/phpmyadmin/index.php", "/phpMyAdmin/index.php", "/Runtime/Logs/", "/wls-wsat/CoordinatorPortType", "/_async/AsyncResponseService"}
	HttpProxy        string
)
