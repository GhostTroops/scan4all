	...
	for !in.IsDelim('}') {
		...
		case "expressions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v49 *MediaQueryExpression
					if in.IsNull() {
						in.Skip()
						v49 = nil
					} else {
						if v49 == nil {
							v49 = new(MediaQueryExpression)
						}
						(*v49).UnmarshalEasyJSON(in)
					}
					out.Expressions = append(out.Expressions, v49)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss42(out *jwriter.Writer, in MediaQuery) {
	...
	_ = first
	{
		...
		if in.Expressions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v50, v51 := range in.Expressions {
				if v50 > 0 {
					out.RawByte(',')
				}
				if v51 == nil {
		...
		case "mediaList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MediaList = append(out.MediaList, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss43(out *jwriter.Writer, in Media) {
	...
	if len(in.MediaList) != 0 {
		...
		{
			out.RawByte('[')
			for v53, v54 := range in.MediaList {
				if v53 > 0 {
					out.RawByte(',')
				}
				if v54 == nil {
		...
		case "subLayers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SubLayers = append(out.SubLayers, v55)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss44(out *jwriter.Writer, in LayerData) {
	...
	if len(in.SubLayers) != 0 {
		...
		{
			out.RawByte('[')
			for v56, v57 := range in.SubLayers {
				if v56 > 0 {
					out.RawByte(',')
				}
				if v57 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "keyframes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v58 *KeyframeRule
					if in.IsNull() {
						in.Skip()
						v58 = nil
					} else {
						if v58 == nil {
							v58 = new(KeyframeRule)
						}
						(*v58).UnmarshalEasyJSON(in)
					}
					out.Keyframes = append(out.Keyframes, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss46(out *jwriter.Writer, in KeyframesRule) {
	...
	}
	{
		...
		if in.Keyframes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v59, v60 := range in.Keyframes {
				if v59 > 0 {
					out.RawByte(',')
				}
				if v60 == nil {
		...
		case "matchedCSSRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MatchedCSSRules = append(out.MatchedCSSRules, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "pseudoElements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v64 *PseudoElementMatches
					if in.IsNull() {
						in.Skip()
						v64 = nil
					} else {
						if v64 == nil {
							v64 = new(PseudoElementMatches)
						}
						(*v64).UnmarshalEasyJSON(in)
					}
					out.PseudoElements = append(out.PseudoElements, v64)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss49(out *jwriter.Writer, in InheritedPseudoElementMatches) {
	...
	_ = first
	{
		...
		if in.PseudoElements == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v65, v66 := range in.PseudoElements {
				if v65 > 0 {
					out.RawByte(',')
				}
				if v66 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "fonts":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v67 *PlatformFontUsage
					if in.IsNull() {
						in.Skip()
						v67 = nil
					} else {
						if v67 == nil {
							v67 = new(PlatformFontUsage)
						}
						(*v67).UnmarshalEasyJSON(in)
					}
					out.Fonts = append(out.Fonts, v67)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "medias":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Medias = append(out.Medias, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "pseudoElements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v74 *PseudoElementMatches
					if in.IsNull() {
						in.Skip()
						v74 = nil
					} else {
						if v74 == nil {
							v74 = new(PseudoElementMatches)
						}
						(*v74).UnmarshalEasyJSON(in)
					}
					out.PseudoElements = append(out.PseudoElements, v74)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "inherited":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v75 *InheritedStyleEntry
					if in.IsNull() {
						in.Skip()
						v75 = nil
					} else {
						if v75 == nil {
							v75 = new(InheritedStyleEntry)
						}
						(*v75).UnmarshalEasyJSON(in)
					}
					out.Inherited = append(out.Inherited, v75)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "inheritedPseudoElements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v76 *InheritedPseudoElementMatches
					if in.IsNull() {
						in.Skip()
						v76 = nil
					} else {
						if v76 == nil {
							v76 = new(InheritedPseudoElementMatches)
						}
						(*v76).UnmarshalEasyJSON(in)
					}
					out.InheritedPseudoElements = append(out.InheritedPseudoElements, v76)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "cssKeyframesRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v77 *KeyframesRule
					if in.IsNull() {
						in.Skip()
						v77 = nil
					} else {
						if v77 == nil {
							v77 = new(KeyframesRule)
						}
						(*v77).UnmarshalEasyJSON(in)
					}
					out.CSSKeyframesRules = append(out.CSSKeyframesRules, v77)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss56(out *jwriter.Writer, in GetMatchedStylesForNodeReturns) {
	...
	if len(in.MatchedCSSRules) != 0 {
		...
		{
			out.RawByte('[')
			for v78, v79 := range in.MatchedCSSRules {
				if v78 > 0 {
					out.RawByte(',')
				}
				if v79 == nil {
	...
	if len(in.PseudoElements) != 0 {
		...
		{
			out.RawByte('[')
			for v80, v81 := range in.PseudoElements {
				if v80 > 0 {
					out.RawByte(',')
				}
				if v81 == nil {
	...
	if len(in.Inherited) != 0 {
		...
		{
			out.RawByte('[')
			for v82, v83 := range in.Inherited {
				if v82 > 0 {
					out.RawByte(',')
				}
				if v83 == nil {
	...
	if len(in.InheritedPseudoElements) != 0 {
		...
		{
			out.RawByte('[')
			for v84, v85 := range in.InheritedPseudoElements {
				if v84 > 0 {
					out.RawByte(',')
				}
				if v85 == nil {
	...
	if len(in.CSSKeyframesRules) != 0 {
		...
		{
			out.RawByte('[')
			for v86, v87 := range in.CSSKeyframesRules {
				if v86 > 0 {
					out.RawByte(',')
				}
				if v87 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "computedStyle":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v88 *ComputedStyleProperty
					if in.IsNull() {
						in.Skip()
						v88 = nil
					} else {
						if v88 == nil {
							v88 = new(ComputedStyleProperty)
						}
						(*v88).UnmarshalEasyJSON(in)
					}
					out.ComputedStyle = append(out.ComputedStyle, v88)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss62(out *jwriter.Writer, in GetComputedStyleForNodeReturns) {
	...
	if len(in.ComputedStyle) != 0 {
		...
		{
			out.RawByte('[')
			for v89, v90 := range in.ComputedStyle {
				if v89 > 0 {
					out.RawByte(',')
				}
				if v90 == nil {
		...
		case "backgroundColors":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.BackgroundColors = append(out.BackgroundColors, v91)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss64(out *jwriter.Writer, in GetBackgroundColorsReturns) {
	...
	if len(in.BackgroundColors) != 0 {
		...
		{
			out.RawByte('[')
			for v92, v93 := range in.BackgroundColors {
				if v92 > 0 {
					out.RawByte(',')
				}
		...
		case "forcedPseudoClasses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ForcedPseudoClasses = append(out.ForcedPseudoClasses, v94)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss66(out *jwriter.Writer, in ForcePseudoStateParams) {
	...
	}
	{
		...
		if in.ForcedPseudoClasses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v95, v96 := range in.ForcedPseudoClasses {
				if v95 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "fontVariationAxes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v97 *FontVariationAxis
					if in.IsNull() {
						in.Skip()
						v97 = nil
					} else {
						if v97 == nil {
							v97 = new(FontVariationAxis)
						}
						(*v97).UnmarshalEasyJSON(in)
					}
					out.FontVariationAxes = append(out.FontVariationAxes, v97)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss68(out *jwriter.Writer, in FontFace) {
	...
	if len(in.FontVariationAxes) != 0 {
		...
		{
			out.RawByte('[')
			for v98, v99 := range in.FontVariationAxes {
				if v98 > 0 {
					out.RawByte(',')
				}
				if v99 == nil {
		...
		case "classNames":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ClassNames = append(out.ClassNames, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss80(out *jwriter.Writer, in CollectClassNamesReturns) {
	...
	if len(in.ClassNames) != 0 {
		...
		{
			out.RawByte('[')
			for v101, v102 := range in.ClassNames {
				if v101 > 0 {
					out.RawByte(',')
				}
