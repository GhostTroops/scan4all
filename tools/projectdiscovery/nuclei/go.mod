...
require (
	...
	github.com/projectdiscovery/interactsh v1.0.7
	github.com/projectdiscovery/nuclei/v2 v2.8.6
...
require (
	...
	github.com/projectdiscovery/rawhttp v0.1.4 // indirect
	...
	github.com/projectdiscovery/tlsx v1.0.2 // indirect
